...
NRUNS=10;%10; % Number of times we generate a different polynomial

%% Generate folder for results
folder_name=strcat('Results/Degree0',int2str(N),'_NoiseCircular_TestT2');
...
for counter=1:NRUNS
    ...
    % HotT2_p]
    dataset=[dataset; [counter*ones(SNR_nsteps,1) ones(SNR_nsteps,1)*conj(r') gamma_from_real_projection Gauss_test_HZ HotT2_p]];
